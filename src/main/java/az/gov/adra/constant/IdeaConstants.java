...
public class IdeaConstants {
    ...
    public static final String IDEA_CHOICE_IDEA = "idea";
    public static final String IDEA_CHOICE_COMPLAINT = "complaint";

    public static final Integer IDEA_OFFSET_NUMBER = 0;
