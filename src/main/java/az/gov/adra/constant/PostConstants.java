...
public class PostConstants {
    ...
    public static final Integer POST_STATUS_ACTIVE = 1;
    public static final Integer POST_STATUS_INACTIVE = 0;

    public static final Integer POST_REVIEW_STATUS_ACTIVE = 1;
    public static final Integer POST_REVIEW_STATUS_INACTIVE = 0;
